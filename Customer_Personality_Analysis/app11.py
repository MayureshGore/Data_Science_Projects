# -*- coding: utf-8 -*-
"""
Created on Sat Apr  6 10:39:04 2024
...
X, Y = make_classification(n_samples=1000, n_features=23, n_classes=3, random_state=42)  # Assuming 3 clusters for example

# Split data into training and testing sets
X_train, X_test, Y_train, Y_test = train_test_split(X, Y, test_size=0.2, random_state=42)

# Instantiate a Random Forest classifier
rf_model = RandomForestClassifier(n_estimators=100, max_depth=5, random_state=42)  # Adjust hyperparameters as needed
